...
export default function PuffyButton({children, color='jblue', copy, ...props}: ButtonProps): JSX.Element {
    ...
    // Copy
    const onClickHandler: (e: any)=>void=()=>copy
        ? window.navigator.clipboard.writeText(copy) //if string exists, copy handler
        : ()=>{}; //do nothing if false
